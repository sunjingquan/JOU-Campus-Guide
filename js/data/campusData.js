...
export const campusInfoData = {
    "苍梧校区": [
        { college: "海洋科学与水产学院", majors: ["海洋资源与环境", "海洋科学", "生物技术", "水产养殖学","水族科学与技术","水生动物和医学"] },
        { college: "电子工程学院", majors: ["测控技术与仪器","电子信息工程","电子科学与技术", "通信工程", "自动化", "电气工程及其自动化","海洋信息工程"] },
        { college: "环境与化学工程学院", majors: ["材料化学","环境工程", "化学工程与工艺","水质科学与技术", "高分子材料与工程", "安全工程"] },
        { college: "计算机工程学院", majors: ["计算机科学与技术", "软件工程", "数据科学与大数据技术", "网络工程","网络空间与安全"] },
        { college: "药学院", majors: ["制药工程", "药物制剂", "药物分析"] },
        { college: "体育学院", majors: ["休闲体育","运动训练"] },
        { college: "马可夫洛夫海洋工程学院", majors: ["机器人工程", "船舶与海洋工程"] }
    ],
    "通灌校区": [
        { college: "海洋食品与生物工程学", majors: ["食品科学与工程", "生物工程","动植物检疫","食品质量与安全"] },
        { college: "海洋工程学院", majors: ["船舶与海洋工程", "海洋资源开发技术"] },
        { college: "机械工程学院", majors: ["机械设计制造及其自动化", "机械电子工程", "机器人工程","过程装备与控制工程","工业工程"] },
        { college: "土木与港海工程学院", majors: ["土木工程", "建筑学", "港口航道与海岸工程", "工程管理"] },
        { college: "海洋技术与测绘学院", majors: ["测绘工程", "海洋技术", "地理信息科学", "遥感科学与技术","应用气象学"] },
        { college: "理学院", majors: ["信息与计算科学", "统计学","光电信息科学与工程", "新能源科学与工程", "数学与应用数学"] },
        { college: "商学院", majors: ["金融学", "国际经济与贸易", "市场营销","工商管理", "会计学", "财务管理", "物流管理"] },
        { college: "文法学院", majors: ["汉语言文学", "新闻学", "法学", "广告学","行政管理","土地资源管理"] },
        { college: "外国语学院", majors: ["英语", "日语", "俄语","朝鲜语"] },
